...
public class ChatterbookController {
    ...
    public List<User> getUserByName(@PathVariable String name){
        List<User> foundNames = new ArrayList<>();
    ...
    public List<ChatterPost> getPostByUserName(@PathVariable String name){
        List<ChatterPost> post = null;
        for (User i : userList){
            if(i.getName().equals(i)){
                //post = post.getChatterPost();
            }
        }
        return post;
    }
